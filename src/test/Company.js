    ...
    Company.prototype.getToken = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, TokenManager_1.TokenManager.getToken(this)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_3 = _a.sent();
                        console.error('Error retrieving sessions from the database:', error_3);
                        throw error_3;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_4 = _a.sent();
                        console.error('Error retrieving repositories from the database:', error_4);
                        throw error_4;
                    case 4: return [2 /*return*/];
                }
            });
